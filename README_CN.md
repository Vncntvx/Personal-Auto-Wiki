...
- 📊 **健康检查** — 检测孤立页面、概念缺口、矛盾标注、认知质量和同步状态
...
│   └── Outputs/                  # 分析输出页（查询中的高价值综合）
├── .claude/skills/               # Skills 定义
│   ├── syncing-wiki/             # 完整同步工作流
...
输出 Wiki 状态报告：孤立页面、概念缺口、矛盾标注、认知质量、未同步文件。
...
- AI Agent 运行环境，例如 Claude Code、Codex 等
